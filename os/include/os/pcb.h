...
/**
 * \brief   Initialize the list of free pcbs (pcbFree_h) from the table of pcbs (pcbFree_table)
 ...
 * 
 * \return  Returns null if the list of free pcbs is empty, the first free pcb otherwise
 * 
 * \todo    Test this function
 */
pcb_t* allocPcb();
 ...
 * 
 * \todo    check if the function needs to return a pointer or the actual pcb_t element
 * \todo    Test this function
 */
 ...
 * \param[in] head  Head of the list (dummy element) where to remove first element
 * 
 * \return  Return NULL if the list is empty, otherwise return the deleted element
 *
 * \todo    Test this function
 */
 ...
 * 
 * \return  Return NULL if list pointed by head doesn't contain PCB pointed by "p"
 ...
 *
 * \return  Return TRUE if PCB pointed by "p" has not child, otherwise return FALSE
 */
 ...
 * 
 * \return  Return NULL if "p" has not child, otherwise return the deleted element
 *
 * \todo    Test this function
 */
...
/**
 * \brief   Remove the PCB pointed by "p" from the child (p_child) of the parent (p_parent)
 * \param[in] p Element to be removed from parent's child list
 * 
 * \return  Return NULL if "p" has not a parent, otherwise return the deleted element ("p")
 */
